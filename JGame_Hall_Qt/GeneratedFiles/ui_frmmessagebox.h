...
public:
    ...
    void setupUi(QDialog *frmMessageBox)
    {
        ...
        groupBoxMessage = new QGroupBox(widget_main);
        groupBoxMessage->setObjectName(QString::fromUtf8("groupBoxMessage"));
        labIcoMain = new QLabel(groupBoxMessage);
        ...
        labInfo = new QLabel(groupBoxMessage);
        ...
        layoutWidget = new QWidget(groupBoxMessage);
        ...
        QIcon icon;
        icon.addFile(QString::fromUtf8(":/messagebox/update"), QSize(), QIcon::Normal, QIcon::Off);
        btnOk->setIcon(icon);
        ...
        QIcon icon1;
        icon1.addFile(QString::fromUtf8(":/messagebox/close"), QSize(), QIcon::Normal, QIcon::Off);
    ...
    void retranslateUi(QDialog *frmMessageBox)
    {
        ...
        groupBoxMessage->setTitle(QString());
